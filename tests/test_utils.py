...
def test_moving_avg():
    ...
    t = [ 4.2,  5.8,  7.4,  9. ,  9. ,  7.6,  6.4,  6.4,  5. ,  3.6,  3.8,
        3.4,  1.8,  1.6,  1.4,  1.4,  2. ,  3.6,  5.2,  6.8,  7.8,  7.6,
        6.4,  5.2]
    assert len(m) == len(a)
    assert np.allclose(m, t)

    # Heads up, these should not be different.
    t = [ 3.8,  5.6,  7.4,  9. ,  9. ,  7.6,  6.4,  6.4,  5. ,  3.6,  3.8,
        3.4,  1.8,  1.6,  1.4,  1.4,  2. ,  3.6,  5.2,  6.8,  7.8,  7.6,
        5.8,  4. ]
...
def test_other():
    a = np.array([1,9,9,9,9,9,9,2,3,9,2,2,3,1,1,1,1,3,4,9,9,9,8,3])
    t = [ 0.   ,  1.   ,  1.   ,  1.   ,  1.   ,  1.   ,  1.   ,  0.125,
        0.25 ,  1.   ,  0.125,  0.125,  0.25 ,  0.   ,  0.   ,  0.   ,
        0.   ,  0.25 ,  0.375,  1.   ,  1.   ,  1.   ,  0.875,  0.25 ]
